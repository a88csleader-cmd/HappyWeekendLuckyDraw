...
const PG_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbwPap2Qru4wxrLdm46302RYBNPTGQ2A04II1IofAa_gmgFe2sNMR8yBDCxRMDygf64zFg/exec';  // เปลี่ยนเป็น URL ใหม่หลัง deploy
...
async function pg_fetchPrize(username) {
  try {
...
// ฟังก์ชัน hasPlayed และ recordPlay เหมือนเดิม
...
pg_startBtn.addEventListener('click', async () => {
  ...
  pg_selectedPrize = await pg_fetchPrize(username);
